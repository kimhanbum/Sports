...
<body>
					...
					<div class="article_container">
						<table style='min-width: 0px !important;' class="table table-borderless">
							<thead>
								<tr>
								  <th colspan="3">
								  	<h5>요청 (멘토 글)리스트 <span id="writingcount">${listcount}</span></h5>
								  </th> 
								  <th colspan="2" style="text-align:right">
									<select id="mmSelect" class="form-control1">
          							  <option value="멘토" selected>멘토글 요청</option>
          							  <option value="멘티">멘티글 요청</option>
                					</select>
								  </th>
								</tr>
								<tr>
							...
							<c:if test="${listcount > 0 }">
								<c:forEach var="req" items="${reqlist}">
									<tr>
			  							...
			  							<td><div>${req.mentor_title}</div></td>
										<td colspan="2">
   ...
   <div class="modal" id="detailModal">
    ...
    <script src="${pageContext.request.contextPath}/resources/js/mmatch/mentorReqlist.js"></script>
    <script>
	  //상세정보 보기
