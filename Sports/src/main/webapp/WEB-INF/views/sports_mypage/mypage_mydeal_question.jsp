			...
			<div class="col-lg-6">
				...
				<div class="row">
					<div class="col">
						...
						<div class="tabs">
						<c:forEach var="b" items="${AbuyQuestion}">
							<div class="tab">
								...
								&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
								&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
								<a href="questiondel?num=${b.QUESTION_NUMBER}"><i class="far fa-trash-alt"></i></a>
				...
				<div class="row">
					<div class="col">
						...
						<div class="tabs">
							<c:forEach var="b" items="${AsellQuestion}">
							<div class="tab">
								...
								<b>답글</b><hr>
								<c:if test="${b.QUESTION_ANSWER==null}">
								<form name="forma" id="forma" action="answer">
								<div><textarea  
								id = "tex" name="tex"
