...
<body>
				...
				<div class="row">
					<div class="col-xl-12">
						<div class="hero-cap text-center">
							<h2 style = "font-family :'나눔고딕'"><b>내 멘토/멘티 작성글 정보</b></h2>
						</div>
					</div>
				</div>
			</div>
						...
						<div class="section-title text-center">
							...
							<div class="dmoain-pricing">
								<div class="table-responsive-sm">
									 <i id="Apply" class="fas fa-running">&nbsp;&nbsp;내 작성 멘토 글 
									...
									<table>
										...
										<c:forEach var="mentor" items="${mentorlist}">
											<tr>
												...
												<td><div class="classalign">${mentor.mentor_amount}</div></td>
												<td><div class="classalign">${mentor.mentor_number}</div></td>
												<td><div id="btnSubmit1" onclick="javascript:mentorDetail('${mentor.mentor_code}');" class="submit5">상세보기</div></td>
											</tr>
										</c:forEach>
										</c:if>
										<c:if test="${listcount1 == 0 }">
							...
							<div class="dmoain-pricing">
								<div class="table-responsive-sm">
									<i id="Register" class="fas fa-running">&nbsp;&nbsp;내 작성 멘티 글 
		...
		<div class="modal-dialog" style="max-width: 800px;">
			<div class="modal-content">
				<div class="container" style="padding:0px">
				    ...
				    <div id="detail_btn1" class="mt-40">
					</div>
					<br> 
				</div>
			</div>
  ...
  <!-- 멘티 상세보기 modal -->
   <div class="modal" id="detailMenteeModal">
		<div class="modal-dialog" style="max-width: 800px;">
			<div class="modal-content">
				<div class="container" style="padding:0px">
				    ...
				    <div id="detail_btn2" class="mt-40">
	...
	<script src="${pageContext.request.contextPath}/resources/js/mmatch/mymmwritelist.js"></script>
	<script>
    ...
    function mentorDetail(code){
    	...
    	$.ajax({
    		...
    		success : function(data){
				...
				$('#detail_btn1').empty();
				output='<button style="width:48%" type="button" class="genric-btn info circle" data-dismiss="modal" onclick="javascript:mentorModify('+"'"+data.mentor_code+"'"+');">수정하기</button>'
				      +'<button style="width:48%" type="button" class="genric-btn danger  circle" data-dismiss="modal" onclick="javascript:mentorDel('+"'"+data.mentor_code+"'"+');">삭제하기</button> ';
				$('#detail_btn1').append(output);		
	...
	function menteeDetail(code){
		...
		$.ajax({
			...
			success : function(data){
				...
				$('#detail_btn2').empty();
				output='<button style="width:48%" type="button" class="genric-btn info circle" data-dismiss="modal" onclick="javascript:menteeModify('+"'"+data.mentee_code+"'"+');">수정하기</button>'
				      +'<button style="width:48%" type="button" class="genric-btn danger  circle" data-dismiss="modal" onclick="javascript:menteeDel('+"'"+data.mentee_code+"'"+');">삭제하기</button> ';
				$('#detail_btn2').append(output);						
