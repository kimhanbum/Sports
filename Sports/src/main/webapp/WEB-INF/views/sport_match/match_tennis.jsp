...
<style>
	#icon_box .icon07:after{z-index:1;
						content: '';
					    position: absolute;
...
<jsp:include page="/WEB-INF/views/sport_comm/header.jsp"/>
   <main>
   		<div id="sport_num" style="display:none;">8</div>
       	...
       	<div id="icon_box">
			<div class="web_size">
				<ul>
					...
					<a href="tennis"><li class="icon07 top_icon" data-value="7/" style="background-color:#eb3b04;">테니스</li></a>
     ...
     <div class="slider-active" id="social">
         <div class="single-slider slider-height" data-background="${pageContext.request.contextPath}/resources/image/sport/tennis.jpg">
             <div class="container1">
                 <div class="row d-flex align-items-center justify-content-between">
                     <div class="col-xl-5 col-lg-6 col-md-6 d-none d-md-block">
                         <div class="hero__img" data-animation="bounceIn" data-delay=".4s">
                             <img class="smallsoccer" src="${pageContext.request.contextPath}/resources/image/sport/tennis.jpg" alt="">
                         </div>
                     </div>
