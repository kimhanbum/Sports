						...
						<form method="post">
							...
							<div class="row">
								<div class="col-md-3 form-group">
									<label for="lname">시작가</label><br> <input type="text"
										id="lname" class="form-control" style="width: 200px"
										placeholder="시작가 입력 .. ">
								</div>
								<div class="col-md-3 form-group">
									<label for="lname">즉시구매가</label><br> <input type="text"
										id="lname" class="form-control" style="width: 200px"
										placeholder="즉시구매가 입력 .. ">
								</div>
								<div class="col-md-3 form-group">
									<label for="lname">입찰단위</label><br> <select name='fruits'>
										<option value='' selected>-- 선택 --</option>
										<option value='apple'>1,000원</option>
										<option value='banana'>3,000원</option>
										<option value='lemon'>5,000원</option>
										<option value='lemon'>10,000원</option>
									</select>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-md-6 form-group">
									<label for="message">&emsp;택배 배송</label> <br> <input
										type="radio" name="radio" id="radio0" class="checkbox">
									<label for="radio0" class="input-label radio">선불</label> <input
										type="radio" name="radio" id="radio1" class="checkbox" checked>
									<label for="radio1" class="input-label radio">착불</label>
								</div>
								<div class="col-md-6 form-group">
									<label for="message">경매 기간</label> <br> <input type="date"
										name="endday" min="1980-01-01" max="1987-12-31" required>
								</div>
							</div>
							<hr>
							<div class="row">
